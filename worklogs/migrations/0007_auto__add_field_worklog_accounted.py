...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'WorkLog.accounted'
        db.add_column('worklogs_worklog', 'accounted',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=8, decimal_places=4, blank=True),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'WorkLog.accounted'
        db.delete_column('worklogs_worklog', 'accounted')
    ...
    models = {
        ...
        'worklogs.worklog': {
            ...
            'accounted': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '8', 'decimal_places': '4', 'blank': 'True'}),
