...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'WorkLogEntry.end'
        db.alter_column('worklogs_worklogentry', 'end', self.gf('django.db.models.fields.DateTimeField')(null=True))
    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'WorkLogEntry.end'
        raise RuntimeError("Cannot reverse this migration. 'WorkLogEntry.end' and its values cannot be restored.")
    models = {
        'auth.group': {
